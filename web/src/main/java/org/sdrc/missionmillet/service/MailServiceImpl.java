...
public class MailServiceImpl implements MailService {
	...
	public String sendMail(Mail mail) throws Exception {
		...
		props.put(
				messageSourceNotification.getMessage(Constants.SMTP_HOST_KEY, null, null),
				messageSourceNotification.getMessage(Constants.SMTP_HOST, null, null));
		props.put(messageSourceNotification.getMessage(Constants.SOCKETFACTORY_PORT_KEY,
				null, null), messageSourceNotification.getMessage(
				Constants.SOCKETFACTORY_PORT, null, null));
		props.put(messageSourceNotification.getMessage(Constants.SOCKETFACTORY_CLASS_KEY,
				null, null), messageSourceNotification.getMessage(
				Constants.SOCKETFACTORY_CLASS, null, null));
		props.put(
				messageSourceNotification.getMessage(Constants.SMTP_AUTH_KEY, null, null),
				messageSourceNotification.getMessage(Constants.SMTP_AUTH, null, null));
		props.put(
				messageSourceNotification.getMessage(Constants.SMTP_PORT_KEY, null, null),
				messageSourceNotification.getMessage(Constants.SMTP_PORT, null, null));

		javax.mail.Session session = javax.mail.Session.getDefaultInstance(
				props, new javax.mail.Authenticator() {
					protected PasswordAuthentication getPasswordAuthentication() {
						return new PasswordAuthentication(messageSourceNotification
		...
		message.setFrom(new InternetAddress(messageSourceNotification.getMessage(
		...
		String regards = mail.getRegards()==null?"":mail.getRegards();
