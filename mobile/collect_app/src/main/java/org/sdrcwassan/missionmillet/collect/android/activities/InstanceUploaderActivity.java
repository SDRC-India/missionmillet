...
public class InstanceUploaderActivity extends AppCompatActivity implements InstanceUploaderListener,
    ...
    public void uploadingComplete(HashMap<String, String> result) {
        ...
        if(message.toString().contains("Unauthorized")){
            ...
            message.append(getResources().getString(R.string.unauthorized_access_while_sync));
        }
            ...
            public void onClick(DialogInterface dialog, int i) {
                switch (i) {
                    case DialogInterface.BUTTON_POSITIVE: // ok
                        ...
                        alertShowing = false;
                        if(message.equalsIgnoreCase(getResources().getString(R.string.unauthorized_access_while_sync))){
                            SQLiteDatabase db = openOrCreateDatabase("SDRCCollectDB", MODE_PRIVATE, null);
                      ...
                      * */
                            ...
                            //code end
                            Intent in = new Intent(InstanceUploaderActivity.this,LoginActivity.class);
