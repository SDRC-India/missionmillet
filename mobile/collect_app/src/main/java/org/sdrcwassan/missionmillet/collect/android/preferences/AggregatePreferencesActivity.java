...
public class AggregatePreferencesActivity extends PreferenceActivity {
	...
	//Ratikanta 
	//Not needed anymore, We are not giving the form credentials to the user to change and we will have multiple credentials also. So there is no value keeping this
...
//		mPasswordPreference = (EditTextPreference) findPreference(PreferencesActivity.KEY_PASSWORD);
		...
		//Ratikanta 
		//The bellow three lines are to disable the preferences because we are giving the DGA url, username and password
