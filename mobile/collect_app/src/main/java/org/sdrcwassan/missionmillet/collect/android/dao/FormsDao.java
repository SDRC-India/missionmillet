...
package org.sdrcwassan.missionmillet.collect.android.dao;
...
import org.sdrcwassan.missionmillet.collect.android.dto.Form;
import org.sdrcwassan.missionmillet.collect.android.provider.FormsProviderAPI;
import org.sdrcwassan.missionmillet.collect.android.provider.FormsProvider;
...
public class FormsDao {
    ...
    public Cursor getFormsCursor(CharSequence charSequence, String sortOrder) {
        ...
        if (charSequence.length() == 0) {
            ...
            cursor = getFormsCursor(null, selection, null, sortOrder);
        } else {
            //amit
            //return managedQuery(FormsProviderAPI.FormsColumns.CONTENT_URI, null, selection, null, getSortingOrder());
            //end
            selection += " AND " + FormsProviderAPI.FormsColumns.DISPLAY_NAME + " LIKE ?";
    ...
    public Cursor getFormsCursor(String[] projection, String selection, String[] selectionArgs, String sortOrder) {
      /*  here the sorting order parameter is commented due to place the order of as it comes from server.
      * author:@Subhadarshani*/

        return Collect.getInstance().getContentResolver().query(FormsProviderAPI.FormsColumns.CONTENT_URI, projection, selection, selectionArgs, "");
    }
