...
public class FormManagementPreferences extends BasePreferenceFragment {
    ...
    private void initConstraintBehaviorPref() {
        final ListPreference pref = (ListPreference) findPreference(PreferenceKeys.KEY_CONSTRAINT_BEHAVIOR);
    ...
    private void initAutoSendPrefs() {
        final ListPreference autosend = (ListPreference) findPreference(PreferenceKeys.KEY_AUTOSEND);
