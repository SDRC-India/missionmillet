...
import org.sdrcwassan.missionmillet.collect.android.activities.GeoPointActivity;
import org.sdrcwassan.missionmillet.collect.android.activities.GeoPointMapActivity;
import org.sdrcwassan.missionmillet.collect.android.activities.GeoPointOsmMapActivity;
...
public class GeoPointWidget extends QuestionWidget implements IBinaryWidget {
    ...
    public GeoPointWidget(Context context, FormEntryPrompt prompt) {
        ...
        answerDisplay.setId(newUniqueId());
        ...
        getLocationButton.setId(newUniqueId());
    ...
    private void updateButtonLabelsAndVisibility(boolean dataAvailable) {
        ...
        if (useMapsV2 && useMaps) {
            ...
            getLocationButton.setVisibility(VISIBLE);
            ...
            if (readOnly) {
                getLocationButton.setVisibility(GONE);
            } else {
                getLocationButton.setVisibility(VISIBLE);
