...
package org.sdrcwassan.missionmillet.collect.android.database;
 ...
 * tries
 * to open the database read/write. I don't think this will ever happen in DGA, though. (fingers
 * crossed).
 */
