...
import org.sdrcwassan.missionmillet.collect.android.adapters.FileArrayAdapter;
import org.sdrcwassan.missionmillet.collect.android.application.Collect;
import org.sdrcwassan.missionmillet.collect.android.listeners.GoogleDriveFormDownloadListener;
import org.sdrcwassan.missionmillet.collect.android.listeners.TaskListener;
import org.sdrcwassan.missionmillet.collect.android.logic.DriveListItem;
...
public class GoogleDriveActivity extends AppCompatActivity implements
     ...
     * is granted.
     */
    @AfterPermissionGranted(InstanceGoogleSheetsUploader.REQUEST_PERMISSION_GET_ACCOUNTS)
        ...
        if (EasyPermissions.hasPermissions(
            ...
            if (!googleUsername.equals("")) {
                ...
                startActivityForResult(
                        ...
                        InstanceGoogleSheetsUploader.REQUEST_ACCOUNT_PICKER);
            }
        } else {
            ...
            EasyPermissions.requestPermissions(
                    ...
                    InstanceGoogleSheetsUploader.REQUEST_PERMISSION_GET_ACCOUNTS,
    ...
    protected void onActivityResult(final int requestCode, final int resultCode,
                                    final Intent data) {
        switch (requestCode) {
            case InstanceGoogleSheetsUploader.REQUEST_ACCOUNT_PICKER:
                ...
                break;
            case InstanceGoogleSheetsUploader.REQUEST_AUTHORIZATION:
