 ...
 * @author carlhartung
 */
public class DownloadFormListTask extends AsyncTask<Void, String, LinkedHashMap<String, FormDetails>> {
    ...
    @Override
    protected LinkedHashMap<String, FormDetails> doInBackground(Void... values) {
        ...
        if (result.isOpenRosaResponse) {
            ...
            for (int i = 0; i < elements; ++i) {
                ...
                //Ratikanta
                formList.put(formId, new FormDetails(formName, downloadUrl, manifestUrl, formId, (version != null) ? version : majorMinorVersion , username, password));
                //Ratikanta end
            }
        } else {
            ...
            for (int i = 0; i < formsCount; ++i) {
                ...
                if (tag.equalsIgnoreCase("form")) {
                    ...
                    //Ratikanta
                    formList.put(formName, new FormDetails(formName, downloadUrl, null, formId, null, null, null));
                    //Ratikanta end
    ...
    @Override
    protected void onPostExecute(LinkedHashMap<String, FormDetails> value) {
        synchronized (this) {
