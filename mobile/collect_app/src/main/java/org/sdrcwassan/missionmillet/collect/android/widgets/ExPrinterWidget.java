...
/**
 * <p>Use the DGA Sensors framework to print data to a connected printer.</p>
 *
 ...
 *
 * <p>The DGA Sensors Zebra printer uses this appearance (intent):</p>
 * <pre>
 ...
 *            &lt;value form="noPrinterErrorString"&gt;DGA Sensors Zebra Printer is not installed!
 *             Please install DGA Sensors Framework and DGA Sensors Zebra Printer from Google
 * Play.&lt;/value&gt;
 *          &lt;/text&gt;
 *        &lt;/translation&gt;
 *      &lt;/itext&gt;
