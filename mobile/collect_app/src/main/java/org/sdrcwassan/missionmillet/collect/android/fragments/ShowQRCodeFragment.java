...
import org.sdrcwassan.missionmillet.collect.android.activities.ScannerWithFlashlightActivity;
import org.sdrcwassan.missionmillet.collect.android.application.Collect;
import org.sdrcwassan.missionmillet.collect.android.listeners.QRCodeListener;
import org.sdrcwassan.missionmillet.collect.android.preferences.AdminPreferencesActivity;
import org.sdrcwassan.missionmillet.collect.android.utilities.CompressionUtils;
...
import org.sdrcwassan.missionmillet.collect.android.utilities.QRCodeUtils;
...
public class ShowQRCodeFragment extends Fragment implements View.OnClickListener, QRCodeListener {
    ...
    private Collection<String> getSelectedPasswordKeys() {
        ...
        if (checkedItems[1]) {
            keys.add(PreferenceKeys.KEY_PASSWORD);
        }
        return keys;
    }
    ...
    private class GenerateQRCode extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Void... params) {
            return QRCodeUtils.generateQRBitMap(getSelectedPasswordKeys());
        }
    }
}
