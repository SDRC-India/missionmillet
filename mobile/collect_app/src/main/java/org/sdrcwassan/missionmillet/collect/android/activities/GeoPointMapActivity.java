...
import org.sdrcwassan.missionmillet.collect.android.spatial.MapHelper;
import org.sdrcwassan.missionmillet.collect.android.utilities.InfoLogger;
import org.sdrcwassan.missionmillet.collect.android.utilities.ToastUtils;
import org.sdrcwassan.missionmillet.collect.android.widgets.GeoPointWidget;
...
public class GeoPointMapActivity extends FragmentActivity implements LocationListener,
    ...
    private void setupMap(GoogleMap googleMap) {
        ...
        reloadLocation.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (marker != null) {
                    marker.remove();
        ...
        zoomLocationButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                zoomToLocation();
                zoomDialog.dismiss();
        ...
        zoomPointButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                zoomToPoint();
                zoomDialog.dismiss();
        ...
        clearPointButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (marker != null) {
                    marker.remove();
