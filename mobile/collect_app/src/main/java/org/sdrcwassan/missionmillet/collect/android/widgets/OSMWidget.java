...
public class OSMWidget extends QuestionWidget implements IBinaryWidget {
    ...
    public OSMWidget(Context context, FormEntryPrompt prompt) {
        ...
        launchOpenMapKitButton.setOnClickListener(new OnClickListener() {
            @Override
        ...
        if (prompt.isReadOnly()) {
            launchOpenMapKitButton.setVisibility(GONE);
        }
        errorTextView.setVisibility(GONE);
    }
    ...
    /**
     * See: https://github.com/AmericanRedCross/openmapkit/wiki/DGA-Collect-Tag-Intent-Extras
     */
