...
import org.sdrcwassan.missionmillet.collect.android.activities.DrawActivity;
...
public class AnnotateWidget extends QuestionWidget implements IBinaryWidget {
    ...
    public AnnotateWidget(Context context, FormEntryPrompt prompt) {
        ...
        captureButton.setId(newUniqueId());
        ...
        chooseButton.setId(newUniqueId());
        ...
        annotateButton.setId(newUniqueId());
        ...
        if (prompt.isReadOnly()) {
            ...
            annotateButton.setVisibility(GONE);
        }
        errorTextView.setVisibility(GONE);
