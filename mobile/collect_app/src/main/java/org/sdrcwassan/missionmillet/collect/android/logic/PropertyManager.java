...
package org.sdrcwassan.missionmillet.collect.android.logic;
...
public class PropertyManager implements IPropertyManager {
    ...
    public PropertyManager(Context context) {
        ...
        try {
            ...
            initUserDefined(prefs, PreferenceKeys.KEY_METADATA_USERNAME,    PROPMGR_USERNAME,      SCHEME_USERNAME);
            initUserDefined(prefs, PreferenceKeys.KEY_METADATA_PHONENUMBER, PROPMGR_PHONE_NUMBER,  SCHEME_TEL);
            initUserDefined(prefs, PreferenceKeys.KEY_METADATA_EMAIL,       PROPMGR_EMAIL,         SCHEME_MAILTO);
