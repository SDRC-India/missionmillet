...
import org.sdrcwassan.missionmillet.collect.android.logic.FormController.InstanceMetadata;
...
public class EncryptionUtils {
    ...
    public static EncryptedFormInformation getEncryptedFormInformation(Uri uri,
        ...
        try {
            if (cr.getType(uri) == InstanceProviderAPI.InstanceColumns.CONTENT_ITEM_TYPE) {
            ...
            } else if (cr.getType(uri) == FormsProviderAPI.FormsColumns.CONTENT_ITEM_TYPE) {
