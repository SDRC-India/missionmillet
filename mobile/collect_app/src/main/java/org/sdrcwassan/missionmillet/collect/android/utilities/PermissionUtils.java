...
import org.sdrcwassan.missionmillet.collect.android.activities.CollectAbstractActivity;
...
import org.sdrcwassan.missionmillet.collect.android.activities.SplashScreenActivity;
            ...
            public void onPermissionsChecked(MultiplePermissionsReport report) {
                if (report.areAllPermissionsGranted()) {
                    ...
                    builder.setTitle(R.string.storage_runtime_permission_denied_title)
                            ...
                            .setCancelable(false)
                            .setIcon(R.drawable.direction_arrow)
                            .show();
                }
            }
