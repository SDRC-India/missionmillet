...
import org.sdrcwassan.missionmillet.collect.android.activities.GeoTraceGoogleMapActivity;
import org.sdrcwassan.missionmillet.collect.android.activities.GeoTraceOsmMapActivity;
...
public class GeoTraceWidget extends QuestionWidget implements IBinaryWidget {
    ...
    public GeoTraceWidget(Context context, FormEntryPrompt prompt) {
        ...
        createTraceButton.setId(newUniqueId());
