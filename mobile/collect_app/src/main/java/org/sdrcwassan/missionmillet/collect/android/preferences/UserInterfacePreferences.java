...
public class UserInterfacePreferences extends BasePreferenceFragment {
    ...
    private void initNavigationPrefs() {
        final ListPreference pref = (ListPreference) findPreference(PreferenceKeys.KEY_NAVIGATION);
    ...
    private void initFontSizePref() {
        final ListPreference pref = (ListPreference) findPreference(PreferenceKeys.KEY_FONT_SIZE);
    ...
    private void initLanguagePrefs() {
        final ListPreference pref = (ListPreference) findPreference(PreferenceKeys.KEY_APP_LANGUAGE);
        ...
        if (pref != null) {
            ...
            pref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    edit.putString(PreferenceKeys.KEY_APP_LANGUAGE, newValue.toString());
                    edit.apply();
    ...
    private void initSplashPrefs() {
        final PreferenceScreen pref = (PreferenceScreen) findPreference(PreferenceKeys.KEY_SPLASH_PATH);
    ...
    private void initMapPrefs() {
        final ListPreference mapSdk = (ListPreference) findPreference(PreferenceKeys.KEY_MAP_SDK);
        final ListPreference mapBasemap = (ListPreference) findPreference(PreferenceKeys.KEY_MAP_BASEMAP);
        ...
        mapSdk.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                int index = ((ListPreference) preference).findIndexOfValue(newValue.toString());
                if (index == PreferenceKeys.ARRAY_INDEX_GOOGLE_MAPS) {
                    ...
                    mapBasemap.setValue(PreferenceKeys.GOOGLE_MAPS_BASEMAP_DEFAULT);
                    ...
                    mapBasemap.setValue(PreferenceKeys.OSM_MAPS_BASEMAP_DEFAULT);
                    mapBasemap.setSummary(mapBasemap.getEntry());
                }
        ...
        if (mapSdk.getValue().equals(PreferenceKeys.OSM_BASEMAP_KEY)) {
            mapBasemap.setEntryValues(R.array.map_osm_basemap_selector_entry_values);
            mapBasemap.setEntries(R.array.map_osm_basemap_selector_entries);
        } else {
            mapBasemap.setEntryValues(R.array.map_google_basemap_selector_entry_values);
    ...
    void setSplashPath(String path) {
        ...
        PreferenceScreen splashPathPreference = (PreferenceScreen) findPreference(PreferenceKeys.KEY_SPLASH_PATH);
