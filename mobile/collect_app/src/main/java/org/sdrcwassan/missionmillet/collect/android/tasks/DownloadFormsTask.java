...
import org.sdrcwassan.missionmillet.collect.android.exception.TaskCancelledException;
...
import org.sdrcwassan.missionmillet.collect.android.utilities.DocumentFetchResult;
 ...
 * @author msundt
 * @author carlhartung
 * @Ratikanta Pradhan (ratikanta@sdrc.co.in)
 * @@author Amit Kumar Sahoo (amit@sdrc.co.in)
 */
public class DownloadFormsTask extends
        AsyncTask<ArrayList<FormDetails>, String, LinkedHashMap<FormDetails, String>> {
    ...
    @Override
    protected LinkedHashMap<FormDetails, String> doInBackground(ArrayList<FormDetails>... values) {
        ...
        LinkedHashMap<FormDetails, String> result = new LinkedHashMap<FormDetails, String>();
    ...
    private UriResult findExistingOrCreateNewUri(File formFile) throws TaskCancelledException {
        ...
        try {
            ...
            if (isNew) {
                ...
                HashMap<String, String> formInfo = FileUtils.parseXML(formFile,mContext);
                ...
                Log.i("hello",formInfo.get(FileUtils.SUBMISSIONURI) + " formid :"+formInfo.get(FileUtils.FORMID));
                ...
                //save the data in shared preference, for updation mediafiles
                Date today = new Date();
                String ts = new SimpleDateFormat(mContext
                ...
                editor.putString(formInfo.get(FileUtils.FORMID), sdf.format(new Date()));
                editor.commit();
...
//                }
    ...
    @Override
    protected void onPostExecute(LinkedHashMap<FormDetails, String> value) {
        synchronized (this) {
