...
package org.sdrcwassan.missionmillet.collect.android.application;
...
import org.sdrcwassan.missionmillet.collect.android.BuildConfig;
import org.sdrcwassan.missionmillet.collect.android.R;
import org.sdrcwassan.missionmillet.collect.android.database.ActivityLogger;
...
import org.sdrcwassan.missionmillet.collect.android.logic.PropertyManager;
import org.sdrcwassan.missionmillet.collect.android.preferences.AutoSendPreferenceMigrator;
import org.sdrcwassan.missionmillet.collect.android.utilities.LocaleHelper;
import org.sdrcwassan.missionmillet.collect.android.preferences.FormMetadataMigrator;
import org.sdrcwassan.missionmillet.collect.android.preferences.PreferenceKeys;
import org.sdrcwassan.missionmillet.collect.android.utilities.AgingCredentialsProvider;
import org.sdrcwassan.missionmillet.collect.android.utilities.AuthDialogUtility;
import org.sdrcwassan.missionmillet.collect.android.utilities.PRNGFixes;
...
public class Collect extends Application {
    ...
    private boolean controlFromFillBlankForm;
    private boolean controlFromEditForm;
    //Ratikanta end
    ...
    public static void createODKDirs() throws RuntimeException {
        ...
        for (String dirName : dirs) {
            ...
            if (!dir.exists()) {
                if (!dir.mkdirs()) {
                    throw new RuntimeException("Millet Mission reports :: Cannot create directory: "
                            + dirName);
                }
            } else {
                if (!dir.isDirectory()) {
                    throw new RuntimeException("Millet Mission reports :: " + dirName
    ...
    public String getVersionedAppName() {
        ...
        versionName = "v"+ versionName + " (" + BuildConfig.VERSION_CODE + ")";
