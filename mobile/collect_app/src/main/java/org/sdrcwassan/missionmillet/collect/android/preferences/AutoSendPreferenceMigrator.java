...
public class AutoSendPreferenceMigrator {
    ...
    public static void migrate() {
        ...
        boolean autoSendWifi = GeneralSharedPreferences.getInstance().getBoolean(PreferenceKeys.KEY_AUTOSEND_WIFI, false);
        boolean autoSendNetwork = GeneralSharedPreferences.getInstance().getBoolean(PreferenceKeys.KEY_AUTOSEND_NETWORK, false);
    ...
    public static void migrate(JSONObject generalPrefsJson) throws JSONException {
        ...
        if (generalPrefsJson.has(PreferenceKeys.KEY_AUTOSEND_WIFI)) {
            autoSendWifi = true;
        }

        boolean autoSendNetwork = false;
        if (generalPrefsJson.has(PreferenceKeys.KEY_AUTOSEND_NETWORK)) {
