...
package org.sdrcwassan.missionmillet.collect.android.dto;
...
public class Form {
    ...
    private Form(Form.Builder builder) {
        ...
        date = builder.date;
        mediaUpdatedDate = builder.mediaUpdatedDate;
    ...
    public static class Builder {
        ...
        public Builder mediaUpdatedDate(Long mediaUpdatedDate) {
            this.mediaUpdatedDate = mediaUpdatedDate;
            return this;
        }
    ...
    public Long getMediaUpdatedDate() {
        return mediaUpdatedDate;
    }

    public void setMediaUpdatedDate(Long mediaUpdatedDate) {
        this.mediaUpdatedDate = mediaUpdatedDate;
    }
