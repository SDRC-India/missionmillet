...
import org.sdrcwassan.missionmillet.collect.android.preferences.filters.ControlCharacterFilter;
import org.sdrcwassan.missionmillet.collect.android.preferences.filters.WhitespaceFilter;
...
public class ServerPreferencesFragment extends BasePreferenceFragment implements View.OnTouchListener, Preference.OnPreferenceChangeListener {
    ...
    protected void setDefaultAggregatePaths() {
        ...
        sharedPreferences.reset(PreferenceKeys.KEY_FORMLIST_URL);
        sharedPreferences.reset(PreferenceKeys.KEY_SUBMISSION_URL);
    }
}
