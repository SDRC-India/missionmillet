    ...
    public static QuestionWidget createWidgetFromPrompt(FormEntryPrompt fep, Context context,
        ...
        switch (fep.getControlType()) {
            case Constants.CONTROL_INPUT:
                switch (fep.getDataType()) {
                    ...
                    case Constants.DATATYPE_TEXT:
                        ...
                        if (query != null) {
                           if(appearance.contains("search")){
                             // questionWidget = new ItemsetWidget(context, fep,readOnlyOverride,false,"search");
                               if(appearance.startsWith("quick")){
                                   questionWidget = new SelectOneExternalSearchWidget(context, fep,readOnlyOverride,true);

                               }else{
                                   questionWidget = new SelectOneExternalSearchWidget(context, fep,readOnlyOverride,false);
                               }
            ...
            case Constants.CONTROL_SELECT_ONE:
                ...
                // consider traditional DGA appearance to be first word in appearance string
                ...
                }else if(appearance.equalsIgnoreCase("quick search()")){
